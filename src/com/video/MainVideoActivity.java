...
public class MainVideoActivity extends AppCompatActivity implements Session.SessionListener, PublisherKit.PublisherListener, SubscriberKit.SubscriberListener, CameraDialog.CameraDialogParent{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_video_activity);
        ...
        if (mSessionId.isEmpty()){
            ...
            Toast.makeText(MainVideoActivity.this, "Please Add Session, Token, ApiKey to ApiConfig.java", Toast.LENGTH_LONG).show();
            return;
        }
